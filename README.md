...
**Leader Board** is a simple project to add name and score on a display board.
...
```sh
  git clone https://github.com/abiola-arobieke/leaderboard.git
```
...
- [ ] **Consume Api Using Javasript Async**
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/leaderboard/issues).
